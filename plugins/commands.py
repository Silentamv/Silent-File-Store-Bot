...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 FOLLOW ME ON INSTAGRAM', url='https://www.instagram.com/silent_amv_?igsh=MW1kOGN1ZWUxZ2dsdg==')
            ],[
            InlineKeyboardButton('🔍 MOVIE SEARCH GROUP', url='https://t.me/movieseriesanimehindi'),
            InlineKeyboardButton('🤖 ANIME GROUP', url='https://t.me/anime_movies_series_hindi_dub')
            ],[

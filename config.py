...
DB_URI = environ.get("DB_URI", "mongodb+srv://Silent:Arunava@123@atlascluster.btk4mu1.mongodb.net/?retryWrites=true&w=majority&appName=AtlasCluster")
DB_NAME = environ.get("DB_NAME", "silentbot")
